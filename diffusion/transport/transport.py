...
class Transport:
    ...
    def __init__(
        ...
        *,
        ...
        self.path_sampler:path.ICPlan | path.GVPCPlan | path.VPCPlan = path_options[path_type]()
    ...
    def sample(self, x1):
        ...
        t = t.to(x1)
        t = 1 - self.time_dist_shift * (1 - t) / (1 + (self.time_dist_shift - 1) * (1 - t))
        return t, x0, x1
    ...
    def convert_score(self, score, x, t):
        """Convert score to velocity"""
        return self.path_sampler.get_score_from_velocity(score, x, t)
    ...
    def __get_sde_diffusion_and_drift(
        ...
        *,
        ...
        def sde_drift(x, t, model, **kwargs):
            temp = self.drift(x, t, model, **kwargs)
            score_temp = self.transport.convert_score(temp, x, t)
            return temp + diffusion_fn(x, t) * score_temp
